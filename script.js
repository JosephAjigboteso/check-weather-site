...
//save default city to local storage
...
function getWeatherUpdate (cityName){
    ...
    .catch(error =>{
        if(error.message === 'City not found'){
             handleError('City not found. Please check the name.');
        }else if (error.message === "Server error") {
                handleError("Something went wrong with the server.");
            } else {
                // Likely a network error (fetch didn't complete)
